...
class BaseModule:
    ...
    def get_synthesis_files(self):
        ...
        return self._get_file_list(folders, self._source_code_file_endings)
    ...
    def get_simulation_files(self):
        ...
        return self.get_synthesis_files() + self._get_file_list(test_folders, self._source_code_file_endings)
